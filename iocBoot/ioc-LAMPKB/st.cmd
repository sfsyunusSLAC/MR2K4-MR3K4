...
epicsEnvSet("IOCNAME", "ioc-LAMPKB" )
epicsEnvSet("ENGINEER", "pcds" )
epicsEnvSet("LOCATION", "PLC:LAMPKB" )
...
epicsEnvSet("IPADDR",           "172.21.148.45")
epicsEnvSet("AMSID",            "172.21.148.45.1.1")
...
epicsEnvSet("MOTOR_PREFIX",    "PLC:LAMPKB:")
epicsEnvSet("MOTOR_NAME",      "M2K4:X")
epicsEnvSet("DESC",            "MAIN.M1 / M2K4 X")
epicsEnvSet("EGU",             "mm")
epicsEnvSet("PREC",            "3")
...
epicsEnvSet("MOTOR_PREFIX",    "PLC:LAMPKB:")
epicsEnvSet("MOTOR_NAME",      "M2K4:Y")
epicsEnvSet("DESC",            "MAIN.M2 / M2K4 Y")
epicsEnvSet("EGU",             "mm")
epicsEnvSet("PREC",            "3")
epicsEnvSet("AXISCONFIG",      "")
epicsEnvSet("ECAXISFIELDINIT", "")
...
epicsEnvSet("MOTOR_PREFIX",    "PLC:LAMPKB:")
epicsEnvSet("MOTOR_NAME",      "M2K4:rY")
epicsEnvSet("DESC",            "MAIN.M3 / M2K4 rY")
...
epicsEnvSet("MOTOR_PREFIX",    "PLC:LAMPKB:")
epicsEnvSet("MOTOR_NAME",      "M3K4:X")
epicsEnvSet("DESC",            "MAIN.M4 / M3K4 X")
epicsEnvSet("EGU",             "mm")
epicsEnvSet("PREC",            "3")
epicsEnvSet("AXISCONFIG",      "")
epicsEnvSet("ECAXISFIELDINIT", "")
...
epicsEnvSet("MOTOR_PREFIX",    "PLC:LAMPKB:")
epicsEnvSet("MOTOR_NAME",      "M3K4:Y")
epicsEnvSet("DESC",            "MAIN.M5 / M3K4 Y")
epicsEnvSet("EGU",             "mm")
epicsEnvSet("PREC",            "3")
epicsEnvSet("AXISCONFIG",      "")
epicsEnvSet("ECAXISFIELDINIT", "")
...
epicsEnvSet("MOTOR_PREFIX",    "PLC:LAMPKB:")
epicsEnvSet("MOTOR_NAME",      "M3K4:rX")
epicsEnvSet("DESC",            "MAIN.M6 / M3K4 rX")
epicsEnvSet("EGU",             "urad")
epicsEnvSet("PREC",            "3")
epicsEnvSet("AXISCONFIG",      "")
epicsEnvSet("ECAXISFIELDINIT", "")
...
dbLoadRecords("iocSoft.db", "IOC=PLC:LAMPKB")
dbLoadRecords("save_restoreStatus.db", "P=PLC:LAMPKB:")
...
save_restoreSet_status_prefix( "PLC:LAMPKB:" )
